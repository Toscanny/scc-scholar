...
$ss_id = $_POST['ss_id'];
$s_image = $_POST['s_image']; //save image in the database//
$slname = $_POST['slname'];
$sfname = $_POST['sfname'];
$smname = $_POST['smname'];
...
<select name="syrlvl" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
