...
echo '<a href="login.php" class="w3-button" style="float:right">LOGIN</a>'; 
echo '<a class="active" class="w3-button"  style="float:right">SIGN UP</a>';
...
<p><b>Requirements </p></b>
  ...
  <button  class="w3-button w3-red w3-block" onclick="window.location.href='unifast.php';"> APPLY NOW!
               </div>
               <br>
          <footer class="w3-container w3-red">
          <button class="w3-button w3-right " 
