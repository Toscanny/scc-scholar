...
// Import CSV
	...
	$object->query = "
	INSERT INTO tbl_newstudent
	(ss_id, sfname, smname, slname, sdbirth, sgender, saddress, scontact, semail, S_disability, s4psno, spwdid,
	s_datefil, sffname, sfmname, sflname, sfoccu, smfname, smmname, smlname, smoccu, spcyincome, spschname,
	sccourse, syrlvl, spass, s_scholar_stat, s_scholarship_type)
	VALUES (:ss_id, :sfname, :smname, :slname, :sdbirth, :sgender, :saddress, :scontact, :semail, :S_disability, :s4psno, :spwdid,
	:s_datefil, :sffname, :sfmname, :sflname, :sfoccu, :smfname, :smmname, :smlname, :smoccu, :spcyincome, :spschname,
	:sccourse, :syrlvl, :spass, :s_scholar_stat, :s_scholarship_type)
	";
