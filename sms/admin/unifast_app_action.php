...
(ss_id, sfname, smname, slname, sdbirth, sgender, saddress, semail, scontact, sccourse, syrlvl,
sffname, sfoccu, smfname, smoccu, spcyincome, s_account_status, s_scholar_stat, s_scholarship_type, s_datefil)
VALUES (:ss_id, :sfname, :smname, :slname, :sdbirth, :sgender, :saddress, :semail, :scontact, :sccourse, :syrlvl,
:sffname, :sfoccu, :smfname, :smoccu, :spcyincome, :s_scholar_stat, 'UNIFAST', '$object->now')";
...
':syrlvl' => $object->clean_input($_POST["syrlvl"]),
// Family Details
// Father Details
...
if($_POST["action"] == 'approve_all')
{
	...
	$object->query = "
	INSERT INTO tbl_student
	(ss_id, slname, sfname, smname, sgender, sdbirth, scontact, saddress, semail,
	syrlvl, sccourse, sffname, smfname, s4psno, spcyincome, 
	s_account_status, s_scholar_stat, s_scholarship_type, s_datefil)
	SELECT ss_id, slname, sfname, smname, sgender, sdbirth, scontact, saddress, semail,
	syrlvl, sccourse, sffname, smfname, s4psno, spcyincome,
	s_account_status, s_scholar_stat, s_scholarship_type, s_datefil
	FROM tbl_newstudent
	WHERE s_id = '".$_POST["checkbox_value"][$count]."'";
